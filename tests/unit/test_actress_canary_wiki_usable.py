...
前的真正閘門）逐字相同，不是自己在 canary 裡寫一份近似判斷（BE-GUARD-01）。這三格
...
_has_meaningful_text() 的 docstring）——三筆假資料都用它讓 _has_meaningful_text 那一半
恆為 True，讓 photo_url 白名單那一半成為唯一的分岔點。
"""
